...
public class DomaciHimna {
    public static void main(String[] args) throws InterruptedException {
        WebDriverManager.chromedriver().setup(); //prvo setujemo driver
        WebDriver driver = new ChromeDriver(); //web driver je novi chromedirver
        WebDriverWait wdwait = new WebDriverWait(driver, Duration.ofSeconds(15));
        driver.manage().window().maximize(); //maiksimizujemo screen
