...
public class AutomobilDrugi {
    ...
    //sa vlasnikom
    public AutomobilDrugi(String marka, String model, int serijskiBroj, String vlasnik) {
        this.marka = marka;
        this.model = model;
    ...
    public AutomobilDrugi(String marka, String model, int serijskiBroj) {
        this.marka = marka;
        this.model = model;
        this.serijskiBroj = serijskiBroj;
    }
